...
git clone https://github.com/immortalwrt/homeproxy kenzo/homeproxy
git clone https://github.com/kenzok8/small-package/tree/main/luci-app-fakemesh kenzo/fakemesh
